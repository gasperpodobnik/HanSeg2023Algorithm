...
docker volume create hanseg2023algorithm-output-$VOLUME_SUFFIX
...
docker run --rm \
        ...
        -v hanseg2023algorithm-output-$VOLUME_SUFFIX:/output/ \
        hanseg2023algorithm
...
docker volume rm hanseg2023algorithm-output-$VOLUME_SUFFIX
